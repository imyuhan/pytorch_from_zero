...
目标:
    1. 抄一遍 02_demo.py 第 7 节的 manual_attention_demo,但内部用 F.scaled_dot_product_attention
    2. 输出形状要和手写版本一致
...
参考答案: 见 doc/04-attention.md 第 4.4.1 节
"""
import torch
...
def sdpa_attention(x: torch.Tensor, w_q, w_k, w_v, valid_mask: torch.Tensor) -> torch.Tensor:
    ...
    raise NotImplementedError("请按 doc/04-attention.md 第 4.4.1 节用 F.scaled_dot_product_attention 实现")
