...
### 4.2.5 typing 工具:`Literal` / `Optional` / `Union`
...
### 4.3.1 `01_hello_world.py` — 最小 FastAPI 应用
...
### 4.3.2 `02_path_query.py` — 路径参数 + Query 参数
...
### 4.3.3 `03_request_body.py` — POST 请求 + 请求体
...
### 4.3.4 `04_pydantic_types.py` — 类型工具
...
### 4.3.5 `05_response_model.py` — 响应控制
...
### 4.3.6 `06_sse_stream.py` — SSE 流式响应
...
### 4.3.7 `07_websocket.py` — WebSocket 双向通信
